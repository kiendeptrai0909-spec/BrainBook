<template>
  <nav id="topbar" class="navbar bg-white border-bottom fixed-top topbar px-3" :class="{ full }">
    <button
      id="toggleBtn"
    ...
    <div>
      ...
      <ul class="list-unstyled d-flex align-items-center mb-0 gap-1">
        ...
        <li>
          <a
            class="position-relative btn-icon btn-sm btn-light btn rounded-circle"
            ...
            <ul class="list-unstyled p-0 m-0">
              <li class="p-3 border-bottom">
                <div class="d-flex gap-3">
                  <img
                    src="/admin-assets/assets/images/avatar/avatar-1.jpg"
                    alt=""
                    class="avatar avatar-sm rounded-circle"
                  />
                  <div class="flex-grow-1 small">
                    <p class="mb-0">Đã nhận đơn hàng mới</p>
                    <p class="mb-1">Đơn #12345 đã được đặt</p>
              ...
              <li class="p-3 border-bottom">
                <div class="d-flex gap-3">
                  <img
                    src="/admin-assets/assets/images/avatar/avatar-4.jpg"
                    alt=""
                    class="avatar avatar-sm rounded-circle"
                  />
                  <div class="flex-grow-1 small">
                    <p class="mb-0">Người dùng mới đăng ký</p>
                    <p class="mb-1">Người dùng @john_doe đã đăng ký</p>
              ...
              <li class="p-3 border-bottom">
                <div class="d-flex gap-3">
                  <img
                    src="/admin-assets/assets/images/avatar/avatar-2.jpg"
                    alt=""
                    class="avatar avatar-sm rounded-circle"
                  />
                  <div class="flex-grow-1 small">
                    <p class="mb-0">Đã xác nhận thanh toán</p>
                    <p class="mb-1">Đã nhận thanh toán $299</p>
...
defineEmits(['toggle-desktop', 'open-mobile'])
</script>
