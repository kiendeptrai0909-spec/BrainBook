        ...
        <div class="row g-5">
          ...
          <div class="col-lg-7">
            ...
            <div class="mb-5">
              ...
              <textarea v-model="form.orderNotes" class="form-control p-3 rounded-3 custom-input" rows="4" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
            </div>
            ...
            <div class="payment-methods bg-light p-4 rounded-3 border">
              ...
              <div class="form-check mb-3 p-3 rounded-3">
                <input v-model="form.paymentMethod" class="form-check-input custom-radio" type="radio" name="paymentMethod" id="bank" value="BANK_TRANSFER">
                <label class="form-check-label fw-bold text-dark fs-5" for="bank">
                  Direct Bank Transfer
                </label>
                <p class="text-primary small mt-1 mb-0">Make your payment directly into our bank account. Your order will not be shipped until the funds have cleared.</p>
              </div>
          ...
          <div class="col-lg-5">
            <div class="order-summary card border-0 rounded-4 shadow-sm" style="background-color: #fcfcfc; border: 1px solid #eee !important;">
              <div class="card-body p-4 p-lg-5">
                ...
                <button type="submit" class="btn btn-place-order w-100 rounded-3 fw-bold fs-5 d-flex justify-content-center align-items-center" :disabled="isProcessing">
                ...
                <p class="text-center text-primary small mt-3 mb-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-shield-lock-fill me-1 mb-1" viewBox="0 0 16 16">
...
const placeOrder = async () => {
  ...
  try {
    ...
    await apiPost('/orders', { body: payload })
    router.push('/success')
  } finally {
